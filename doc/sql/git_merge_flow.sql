...
CREATE TABLE `git_project` (
  ...
  `clone_status` varchar(20) DEFAULT 'NOT_CLONED' COMMENT '克隆状态: NOT_CLONED-未克隆, CLONING-克隆中, CLONED-已克隆, CLONE_FAILED-克隆失败',
  `clone_time` datetime DEFAULT NULL COMMENT '克隆时间',
  `clone_error_msg` text DEFAULT NULL COMMENT '克隆失败错误信息',
  `last_pull_time` datetime DEFAULT NULL COMMENT '最后拉取主分支时间',
  `web_url` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'webUrl',
  `create_by` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT 'SYSTEM' COMMENT '创建人',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_by` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT 'SYSTEM' COMMENT '更新人',
