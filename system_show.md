...
<div align="center">
  ...
  <p><em>当自动合并失败时，系统会提供【web解决冲突】【手动处理冲突】指引</em></p>
</div>
...
<div align="center">
  ...
  <p><em>在web页面，解决代码冲突</em></p>
</div>

<div align="center">
  <img src="doc/img/git_16.jpg" alt="web代码冲突解决并push" width="800"/>
  <p><em>在web页面，解决代码冲突，提交并推送</em></p>
</div>
...
| 🔀 中间分支 | 合并多个分支到统一环境                        |
| 🔄 重新合并 | 一键重建并重新合并所有分支                      |
| 🛠️ 冲突处理 | 提供【web解决冲突】【手动处理冲突】两种方式，自动生成冲突解决脚本 |
| 📝 操作记录 | 记录所有操作日志                           |
